...
// ------------------------------- checkme
const chkfrm2 = document.checkfrm2;
...
joinbtn?.addEventListener('click', () => {
    ...
    else if (addr1.value =='' && addr2.value == '') alert('나머지 주소를 입력하세요!!');
    else if (email1.value =='' && email2.value == '' && email3.value == '') alert('이메일을 확인하세요!!');
    else if (tel1.value == '' && tel2.value == '' && tel3.value == '') alert('전화번호를 확인하세요!!');
    else if (grecaptcha.value == '') alert('자동가입방지 처리에 동의하세요!!');
    else {
